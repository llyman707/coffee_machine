...
def coffee_machine():
    make_coffee = input("What would you like? (espresso/latte/cappuchino): ")

    if make_coffee == 'report':
        return report()
    elif make_coffee == 'latte':
        if total > latte_price:
            print(f"Here is ${total - latte_price} in change.")
        ...
        return latte()
    elif make_coffee == 'espresso':
        paying()
        if total > espresso_price:
            print(f"Here is ${total - espresso_price} in change.")
        ...
        if water >= 50:
            ...
            print("Sorry there was not enough water")
        return espresso()
    elif make_coffee == 'cappuccino':
        if total > cappuccino_price:
            print(f"Here is ${total - cappuccino_price} in change.")
        ...
        if water >= 250:
            if coffee >= 24:
                ...
                print("Sorry there was not enought coffee")
        else:
            print("Sorrt there was not enough water")
        return cappuccino() 
